...
@section('body-content')
	<div class="page-content">
				...
				<div class="ps-3">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb mb-0 p-0">
							...
							<li class="breadcrumb-item active" aria-current="page">All Students Trash List</li>
						</ol>
					</nav>
				</div>
		</div>
		...
		<div class="d-flex align-items-center justify-content-between">
			<h6 class="mb-0 text-uppercase">All Students Trash List</h6>
			<a href="{{ route('student.manage') }}" class="btn btn-dark">Manage All Active Items</a>
		</div>
		<hr>
		<div class="card">
			<div class="card-body">
